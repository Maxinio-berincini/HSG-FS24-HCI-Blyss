...
final List<Product> products = [
  Product(
    ...
    shortDescription:
        'A luxurious fusion of playfulness and Gucci\'s iconic elegance...',
    description:
        'Introducing the exquisite Gucci Seal Teddy Bear - a luxurious blend of whimsy and elegance. This charming collectible is crafted with the finest materials, embodying the sophistication and iconic style synonymous with Gucci. With its plush, velvety fur and endearing features, this teddy bear is more than a toy; it\'s a statement piece and a nod to the playful side of high fashion.',
    price: 420.0,
    rating: 4.5,
  ...
  Product(
    ...
    shortDescription:
        'Experience unparalleled precision with our Premium Ball Valve...',
    description:
        'Introducing the Premium Ball Valve, the epitome of industrial excellence and reliability, designed to provide unmatched control and durability. Constructed from the finest materials, this valve is engineered for optimal performance in any setting, offering precise fluid management with a robust design. Its smooth operation and resistance to wear make it a staple in systems requiring accurate flow regulation, ensuring long-term dependability and efficiency. Perfect for professionals and industries seeking the highest standard in valve technology.',
    price: 142.0,
    rating: 2.5,
  ...
  Product(
    ...
    shortDescription:
        'A meticulously crafted miniature, celebrating precision engineering...',
    description:
        'Experience the thrill of precision engineering with our Supreme Porsche Model, a meticulously crafted replica of the iconic Porsche. This collector’s item is designed with attention to every detail, from the sleek, aerodynamic lines to the intricately detailed interior, replicating the luxury and performance Porsche is known for. Ideal for collectors and automotive enthusiasts, this model not only celebrates the heritage of one of the world’s premier sports cars but also serves as a stunning display piece in any collection.',
    price: 599.0,
    rating: 5,
